...
exp.create_experiment('triple_layer_acs_dense_three_landmark_targeted')
...
exp.add_param('local_a_patch_dense1_num_units', 176)
exp.add_param('local_a_patch_dense2_num_units', 176)
exp.add_param('local_a_patch_dense3_num_units', 176)
exp.add_param('local_c_patch_dense1_num_units', 176)
exp.add_param('local_c_patch_dense2_num_units', 176)
exp.add_param('local_c_patch_dense3_num_units', 176)
exp.add_param('local_s_patch_dense1_num_units', 176)
exp.add_param('local_s_patch_dense2_num_units', 176)
exp.add_param('local_s_patch_dense3_num_units', 176)
...
exp.add_param('prediction_margins', (30, 30, 30))
...
ext.add_feature(
    ...
    pdl.extraction.flat_patch(volume, point, exp.params['local_a_patch_shape'])
)
ext.add_feature(
    feature_name='local_c_patch',
    feature_function=lambda volume, point:
    pdl.extraction.flat_patch(volume, point, exp.params['local_c_patch_shape'])
)
ext.add_feature(
...
net = nolearn.lasagne.NeuralNet(
    layers=[
        ...
        # Layers for the axial patch.
        (lasagne.layers.InputLayer,
         {'name': 'local_a_patch',
          'shape': tuple([None] + exp.params['local_patch_input_shape'])}),
        (lasagne.layers.DenseLayer,
         {'name': 'local_a_patch_dense1',
          'num_units': exp.params['local_a_patch_dense1_num_units']}),
        (lasagne.layers.DenseLayer,
         {'name': 'local_a_patch_dense2',
          'num_units': exp.params['local_a_patch_dense2_num_units']}),
        (lasagne.layers.DenseLayer,
         {'name': 'local_a_patch_dense3',
          'num_units': exp.params['local_a_patch_dense3_num_units']}),

        # Layers for the coronal patch.
        (lasagne.layers.InputLayer,
         {'name': 'local_c_patch',
          'shape': tuple([None] + exp.params['local_patch_input_shape'])}),
        (lasagne.layers.DenseLayer,
         {'name': 'local_c_patch_dense1',
          'num_units': exp.params['local_c_patch_dense1_num_units']}),
        (lasagne.layers.DenseLayer,
         {'name': 'local_c_patch_dense2',
          'num_units': exp.params['local_c_patch_dense2_num_units']}),
        (lasagne.layers.DenseLayer,
         {'name': 'local_c_patch_dense3',
          'num_units': exp.params['local_c_patch_dense3_num_units']}),

        # Layers for the sagittal patch.
        (lasagne.layers.InputLayer,
         {'name': 'local_s_patch',
          'shape': tuple([None] + exp.params['local_patch_input_shape'])}),
        (lasagne.layers.DenseLayer,
         {'name': 'local_s_patch_dense1',
          'num_units': exp.params['local_s_patch_dense1_num_units']}),
        (lasagne.layers.DenseLayer,
         {'name': 'local_s_patch_dense2',
          'num_units': exp.params['local_s_patch_dense2_num_units']}),
        (lasagne.layers.DenseLayer,
         {'name': 'local_s_patch_dense3',
          'num_units': exp.params['local_s_patch_dense3_num_units']}),
        ...
        (lasagne.layers.ConcatLayer,
         {'name': 'join',
          'incomings': ['local_a_patch_dense3', 'local_c_patch_dense3',
                        'local_s_patch_dense3', 'landmark_1_dense3',
                        'landmark_2_dense3', 'landmark_3_dense3']}),
        (lasagne.layers.DenseLayer,
         {'name': 'join_dense1',
