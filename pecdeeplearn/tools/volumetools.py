    ...
    def __getitem__(self, indices):
        ...
        for index in indices:
            if isinstance(index, int):
                ...
                raise IndexError("Volume indices should be ints or slices.")
...
class BatchIterator:
    ...
    def iterate(self, batch_size):
        ...
        input_batch = np.empty((batch_size, num_inputs), dtype='float32')
        output_batch = np.empty(batch_size, dtype='float32')
