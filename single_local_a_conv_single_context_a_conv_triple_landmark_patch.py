...
exp.add_param('context_patch_target_shape', [13, 13, 1])
exp.add_param('context_patch_input_shape', [1, 13, 13])
exp.add_param('landmark_1', 'Sternal angle')
exp.add_param('landmark_2', 'Left nipple')
exp.add_param('landmark_3', 'Right nipple')
exp.add_param('local_patch_conv1_filter_size', (3, 3))
exp.add_param('local_patch_conv1_num_filters', 64)
exp.add_param('context_patch_conv1_filter_size', (3, 3))
