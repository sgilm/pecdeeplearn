...
exp.create_experiment('single_layer_acs_dense_three_landmark_targeted')
...
exp.add_param('local_a_patch_dense1_num_units', 4762)
exp.add_param('local_c_patch_dense1_num_units', 4762)
exp.add_param('local_s_patch_dense1_num_units', 4762)
...
net = nolearn.lasagne.NeuralNet(
    layers=[
        ...
        (lasagne.layers.ConcatLayer,
         {'name': 'join',
          'incomings': ['local_a_patch_dense1', 'local_c_patch_dense1',
                        'local_s_patch_dense1', 'landmark_1_dense1',
                        'landmark_2_dense1', 'landmark_3_dense1']}),
        (lasagne.layers.DenseLayer,
         {'name': 'join_dense1',
