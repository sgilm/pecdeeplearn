...
exp.create_experiment(
    'triple_layer_acs_conv_three_landmark_targeted_context_75'
)
...
exp.add_param('context_a_source_patch_shape', [75, 75, 1])
exp.add_param('context_c_source_patch_shape', [75, 1, 75])
exp.add_param('context_s_source_patch_shape', [1, 75, 75])
