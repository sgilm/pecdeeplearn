...
# Set up a new experiment for saving the predictions to.
exp.create_experiment(
    'secondary_triple_layer_acs_conv_three_landmark_targeted'
)
...
training_maps = [
    ...
    for actual, predicted in training_vols]
...
net = nolearn.lasagne.NeuralNet(
    layers=[
        ...
        # Layers for the axial prob patch.
        (lasagne.layers.InputLayer,
         {'name': 'prob_a_patch',
          'shape': tuple([None] + exp.params['prob_patch_input_shape'])}),
        (lasagne.layers.Conv2DLayer,
         {'name': 'prob_a_patch_conv1',
          'num_filters': exp.params['prob_a_patch_conv1_num_filters'],
          'filter_size': exp.params['prob_a_patch_conv1_filter_size']}),
        (lasagne.layers.MaxPool2DLayer,
         {'name': 'prob_a_patch_pool1',
          'pool_size': exp.params['prob_a_patch_pool1_pool_size']}),
        (lasagne.layers.Conv2DLayer,
         {'name': 'prob_a_patch_conv2',
          'num_filters': exp.params['prob_a_patch_conv2_num_filters'],
          'filter_size': exp.params['prob_a_patch_conv2_filter_size']}),
        (lasagne.layers.MaxPool2DLayer,
         {'name': 'prob_a_patch_pool2',
          'pool_size': exp.params['prob_a_patch_pool2_pool_size']}),
        (lasagne.layers.Conv2DLayer,
         {'name': 'prob_a_patch_conv3',
          'num_filters': exp.params['prob_a_patch_conv3_num_filters'],
          'filter_size': exp.params['prob_a_patch_conv3_filter_size']}),
        (lasagne.layers.MaxPool2DLayer,
         {'name': 'prob_a_patch_pool3',
          'pool_size': exp.params['prob_a_patch_pool3_pool_size']}),
        (lasagne.layers.FlattenLayer, {'name': 'prob_a_patch_flat1'}),

        # Layers for the coronal prob patch.
        (lasagne.layers.InputLayer,
         {'name': 'prob_c_patch',
          'shape': tuple([None] + exp.params['prob_patch_input_shape'])}),
        (lasagne.layers.Conv2DLayer,
         {'name': 'prob_c_patch_conv1',
          'num_filters': exp.params['prob_c_patch_conv1_num_filters'],
          'filter_size': exp.params['prob_c_patch_conv1_filter_size']}),
        (lasagne.layers.MaxPool2DLayer,
         {'name': 'prob_c_patch_pool1',
          'pool_size': exp.params['prob_c_patch_pool1_pool_size']}),
        (lasagne.layers.Conv2DLayer,
         {'name': 'prob_c_patch_conv2',
          'num_filters': exp.params['prob_c_patch_conv2_num_filters'],
          'filter_size': exp.params['prob_c_patch_conv2_filter_size']}),
        (lasagne.layers.MaxPool2DLayer,
         {'name': 'prob_c_patch_pool2',
          'pool_size': exp.params['prob_c_patch_pool2_pool_size']}),
        (lasagne.layers.Conv2DLayer,
         {'name': 'prob_c_patch_conv3',
          'num_filters': exp.params['prob_c_patch_conv3_num_filters'],
          'filter_size': exp.params['prob_c_patch_conv3_filter_size']}),
        (lasagne.layers.MaxPool2DLayer,
         {'name': 'prob_c_patch_pool3',
          'pool_size': exp.params['prob_c_patch_pool3_pool_size']}),
        (lasagne.layers.FlattenLayer, {'name': 'prob_c_patch_flat1'}),

        # Layers for the sagittal prob patch.
        (lasagne.layers.InputLayer,
         {'name': 'prob_s_patch',
          'shape': tuple([None] + exp.params['prob_patch_input_shape'])}),
        (lasagne.layers.Conv2DLayer,
         {'name': 'prob_s_patch_conv1',
          'num_filters': exp.params['prob_s_patch_conv1_num_filters'],
          'filter_size': exp.params['prob_s_patch_conv1_filter_size']}),
        (lasagne.layers.MaxPool2DLayer,
         {'name': 'prob_s_patch_pool1',
          'pool_size': exp.params['prob_s_patch_pool1_pool_size']}),
        (lasagne.layers.Conv2DLayer,
         {'name': 'prob_s_patch_conv2',
          'num_filters': exp.params['prob_s_patch_conv2_num_filters'],
          'filter_size': exp.params['prob_s_patch_conv2_filter_size']}),
        (lasagne.layers.MaxPool2DLayer,
         {'name': 'prob_s_patch_pool2',
          'pool_size': exp.params['prob_s_patch_pool2_pool_size']}),
        (lasagne.layers.Conv2DLayer,
         {'name': 'prob_s_patch_conv3',
          'num_filters': exp.params['prob_s_patch_conv3_num_filters'],
          'filter_size': exp.params['prob_s_patch_conv3_filter_size']}),
        (lasagne.layers.MaxPool2DLayer,
         {'name': 'prob_s_patch_pool3',
          'pool_size': exp.params['prob_s_patch_pool3_pool_size']}),
        (lasagne.layers.FlattenLayer, {'name': 'prob_s_patch_flat1'}),
        ...
        (lasagne.layers.ConcatLayer,
         {'name': 'concat',
          'incomings': ['local_a_patch_flat1', 'local_c_patch_flat1',
                        'local_s_patch_flat1', 'prob_a_patch_flat1',
                        'prob_c_patch_flat1', 'prob_s_patch_flat1',
...
actual_training_vols = [actual for actual, predicted in training_vols]
for i, (input_batch, output_batch) in enumerate(ext.iterate_multiple(
        actual_training_vols, training_maps, exp.params['batch_size'])):
