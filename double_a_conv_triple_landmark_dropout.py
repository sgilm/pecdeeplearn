...
exp.add_param('dropout_prob', 0.5)
...
exp.add_param('join1_dense_num_units', 1000)
exp.add_param('join2_dense_num_units', 1000)
...
net = nolearn.lasagne.NeuralNet(
    layers=[
        ...
        (lasagne.layers.DenseLayer,
         {'name': 'join1_dense',
          'num_units': exp.params['join1_dense_num_units']}),
        (lasagne.layers.DropoutLayer,
         {'name': 'dropout', 'p': exp.params['dropout_prob']}),
        (lasagne.layers.DenseLayer,
         {'name': 'join2_dense',
          'num_units': exp.params['join2_dense_num_units']}),
        (lasagne.layers.DenseLayer,
