...
exp.create_experiment('quintuple_a_conv')
...
exp.add_param('local_patch_conv5_filter_size', (3, 3))
exp.add_param('local_patch_conv5_num_filters', 1024)
exp.add_param('local_patch_pool5_pool_size', (2, 2))
...
net = nolearn.lasagne.NeuralNet(
    layers=[
        ...
        (lasagne.layers.Conv2DLayer,
         {'name': 'local_patch_conv5',
          'num_filters': exp.params['local_patch_conv5_num_filters'],
          'filter_size': exp.params['local_patch_conv5_filter_size'],
          'pad': 'same'}),
        (lasagne.layers.MaxPool2DLayer,
         {'name': 'local_patch_pool5',
          'pool_size': exp.params['local_patch_pool5_pool_size']}),
