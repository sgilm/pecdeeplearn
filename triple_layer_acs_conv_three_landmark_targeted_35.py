...
exp.create_experiment('triple_layer_acs_conv_three_landmark_targeted_35')
exp.add_param('num_training_volumes', 45)
exp.add_param('max_points_per_volume', 25000)
exp.add_param('margins', (17, 17, 17))
exp.add_param('local_a_patch_shape', [35, 35, 1])
exp.add_param('local_c_patch_shape', [35, 1, 35])
exp.add_param('local_s_patch_shape', [1, 35, 35])
exp.add_param('local_patch_input_shape', [1, 35, 35])
        ...
        (lasagne.layers.ConcatLayer,
         {'name': 'concat',
          'incomings': ['local_a_patch_flat1', 'local_c_patch_flat1',
                        'local_s_patch_flat1', 'landmark_1_dense3',
