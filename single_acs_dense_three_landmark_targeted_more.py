...
exp.create_experiment('single_acs_dense_three_landmark_targeted_more')
...
exp.add_param('join_dense1_num_units', 3000)
...
net = nolearn.lasagne.NeuralNet(
    layers=[
        ...
        (lasagne.layers.ConcatLayer,
         {'name': 'join',
          'incomings': ['local_a_patch', 'local_c_patch', 'local_s_patch',
