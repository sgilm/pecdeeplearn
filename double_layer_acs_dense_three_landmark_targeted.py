...
exp.create_experiment('double_layer_acs_dense_three_landmark_targeted')
...
exp.add_param('local_a_patch_dense1_num_units', 855)
exp.add_param('local_a_patch_dense2_num_units', 855)
exp.add_param('local_c_patch_dense1_num_units', 855)
exp.add_param('local_c_patch_dense2_num_units', 855)
exp.add_param('local_s_patch_dense1_num_units', 855)
exp.add_param('local_s_patch_dense2_num_units', 855)
...
net = nolearn.lasagne.NeuralNet(
    layers=[
        ...
        (lasagne.layers.ConcatLayer,
         {'name': 'join',
          'incomings': ['local_a_patch_dense2', 'local_c_patch_dense2',
                        'local_s_patch_dense2', 'landmark_1_dense2',
                        'landmark_2_dense2', 'landmark_3_dense2']}),
        (lasagne.layers.DenseLayer,
         {'name': 'join_dense1',
